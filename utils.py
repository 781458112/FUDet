...
if __name__ == "__main__":
    img_list=[]
    path=r'/home/zh/zhao/MFL_simplenet/SimpleNet-main_GAN/MFL/MFL/test/absent'
    yichang_path = r'/home/zh/zhao/MFL_simplenet/SimpleNet-main_GAN/results/MVTecAD_Results/simplenet_mvtec/run/results.csv'
    image_path=os.listdir(path)
    for image in image_path:
        img_path=os.path.join(path,image)
        img_list.append(img_path)
    plot_segmentation_images(savefolder='output',image_paths=img_list,segmentations=yichang_path)